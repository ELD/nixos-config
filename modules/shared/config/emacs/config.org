...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Eric Dattore"
    user-mail-address "eric@dattore.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/edattore/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/edattore/bin" "/profile/bin" "/Users/edattore/.npm-packages/bin" "/Users/edattore/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
